...
<p><a aria-expanded="false" href="#" data-dropdown="drop" class="tiny button dropdown">Tiny Dropdown Button</a><br>
  <a aria-expanded="false" href="#" data-dropdown="drop" class="small secondary radius button dropdown">Small Secondary
    Radius Dropdown Button</a><br>
  <a aria-expanded="false" href="#" data-dropdown="drop" class="button alert round dropdown">Button Alert Round Dropdown
    Button</a><br>
  <a aria-expanded="false" href="#" data-dropdown="drop" class="large success button dropdown">Large Success Dropdown
    Button</a><br>
  <a aria-expanded="false" href="#" data-dropdown="drop" class="large button dropdown expand">Large Expanded Dropdown
    Button</a></p>
<hr>
<h4 id="split-buttons">Split Buttons</h4>
<p><a href="#" class="tiny button split">Tiny Split Button <span aria-expanded="false"
                                                                 data-dropdown="drop"></span></a><br>
  <a href="#" class="small secondary radius button split">Small Secondary Radius Split Button <span
      aria-expanded="false" data-dropdown="drop"></span></a><br>
  <a href="#" class="button alert round split">Round Alert Split Button <span aria-expanded="false"
                                                                              data-dropdown="drop"></span></a><br>
  <a href="#" class="large success button split">Large Success Split Button <span aria-expanded="false"
                                                                                  data-dropdown="drop"></span></a></p>
<hr>
  ...
  <div class="clearing-assembled">
    <div><a href="#" class="clearing-close">×</a>
      ...
      <div class="visible-img" style="display: none">
        ...
        <img src="http://foundation.zurb.com/docs/assets/img/examples/comet-th-sm.jpg" alt="">

        <p class="clearing-caption"></p><a href="#" class="clearing-main-prev"><span></span></a><a href="#"
                                                                                                   class="clearing-main-next"><span></span></a>
      </div>
      <div class="carousel">
        <ul class="clearing-thumbs" data-clearing="">
          <li><a class="th" href="http://foundation.zurb.com/docs/assets/img/examples/earth-th-sm.jpg"><img
                data-caption="Nulla vitae elit libero, a pharetra augue. Cras mattis consectetur purus sit amet fermentum."
                src="http://foundation.zurb.com/docs/assets/img/examples/earth-th-sm.jpg"></a></li>

          <li><a class="th" href="http://foundation.zurb.com/docs/assets/img/examples/comet-th-sm.jpg"><img
                src="http://foundation.zurb.com/docs/assets/img/examples/comet-th-sm.jpg"></a></li>
...
<div class="flex-video">
  <iframe src="http://www.youtube.com/embed/0_EW8aNgKlA" allowfullscreen="" width="420" frameborder="0"
          height="315"></iframe>
</div>
...
<p>Nullam quis risus eget urna mollis ornare vel eu leo. Donec ullamcorper nulla non metus auctor fringilla. Duis
  mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Vestibulum id ligula porta
...
<div class="row">
  <div class="large-12 columns">
    <div class="orbit-container">
      <ul style="height: 280px;" class="orbit-slides-container" id="featured1" data-orbit=""
          data-options="timer_speed:5000;">
      ...
      <a class="orbit-prev" href="#"><span></span></a><a class="orbit-next" href="#"><span></span></a>

      <div class="orbit-timer paused"><span></span>

        <div style="width: 15.94%;" class="orbit-progress"></div>
      </div>
      <div class="orbit-slide-number"><span>2</span> of <span>3</span></div>
      <div class="orbit-bullets-container">
        <ol class="orbit-bullets">
          <li class="" data-orbit-slide="0"></li>
          <li class="active" data-orbit-slide="1"></li>
...
<div id="firstModal" class="reveal-modal" data-reveal="">
  ...
  <p>Reveal makes these very easy to summon and dismiss. The close button is simply an anchor with a unicode character
    icon and a class of <code>close-reveal-modal</code>. Clicking anywhere outside the modal will also dismiss it.</p>
...
<div id="secondModal" class="reveal-modal" data-reveal="">
  ...
  <p>See? It just slides into place after the first modal. Very handy when you need subsequent dialogs, or when a modal
    option impacts or requires another decision.</p>
  <a class="close-reveal-modal">×</a>
</div>
...
<div id="videoModal" class="reveal-modal large" data-reveal="">
  ...
  <div class="flex-video">
    <iframe src="//www.youtube.com/embed/aiBt44rrslw" allowfullscreen="" width="420" frameborder="0"
            height="315"></iframe>
  </div>
...
<div class="range-slider" data-slider="50">
  <span aria-valuenow="50" aria-valuemax="100" aria-valuemin="0" style="transform: translateX(451.5px);"
...
<div class="range-slider" data-slider="40" data-options="step: 20;">
  <span aria-valuenow="40" aria-valuemax="100" aria-valuemin="0" style="transform: translateX(361px);"
        class="range-slider-handle"></span>
...
<dl class="accordion" data-accordion="">
  ...
  <dd>
    ...
    <div id="panel2" class="content">
      Panel 2. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
  ...
  <dd>
    ...
    <div id="panel3" class="content">
      Panel 3. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
      dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
      commodo consequat.
    </div>
  </dd>
...
<p>The tooltips can be positioned on the <span title="" aria-describedby="tooltip-i1nk4nfj0"
                                               data-selector="tooltip-i1nk4nfj0" data-tooltip="" class="has-tip"
                                               data-width="210">"tip-bottom"</span>, which is the default position,
  <span title="" aria-describedby="tooltip-i1nk4nfj1" data-selector="tooltip-i1nk4nfj1" data-tooltip=""
        class="has-tip tip-top noradius" data-width="210">"tip-top" (hehe)</span>, <span title="" data-tooltip="left"
                                                                                         class="has-tip tip-left"
                                                                                         data-width="90">"tip-left"</span>,
  or <span title="" data-tooltip="right" class="has-tip tip-right" data-width="120">"tip-right"</span> of the target
  element by adding the appropriate class to them. You can even add your own custom class to style each tip differently.
    ...
    <ul class="right">
      ...
      <li class="has-dropdown not-click">
        ...
        <ul class="dropdown">
          ...
          <li class="parent-link show-for-small"><a class="parent-link js-generated" href="#">Main Item 1</a></li>
          <li><label>Section Name</label></li>
          <li class="has-dropdown not-click">
            <a href="#" class="">Has Dropdown, Level 1</a>
            <ul class="dropdown">
              <li class="title back js-generated"><h5><a href="javascript:void(0)">Back</a></h5></li>
              <li class="parent-link show-for-small"><a class="parent-link js-generated" href="#">Has Dropdown, Level
                  1</a></li>
      ...
      <li class="has-dropdown not-click">
        ...
        <ul class="dropdown">
          <li class="title back js-generated"><h5><a href="javascript:void(0)">Back</a></h5></li>
          <li class="parent-link show-for-small"><a class="parent-link js-generated" href="#">Main Item 2</a></li>
          <li><a href="#">Dropdown Option</a></li>
          <li><a href="#">Dropdown Option</a></li>
          <li><a href="#">Dropdown Option</a></li>
          <li class="divider"></li>
...
<div class="type-demo">
  ...
  <br>
  <h5>Blockquote</h5>
  <blockquote>I do not fear computers. I fear the lack of them. Maecenas faucibus mollis interdum. Aenean lacinia
    bibendum nulla sed consectetur.<cite>Isaac Asimov</cite></blockquote>
  ...
  <ul class="vcard">
    ...
    <li class="email"><a href="#">g.baltar@example.com
