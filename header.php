...
<html class="no-js" lang="en">
  ...
  <head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
          href="<?php echo get_template_directory_uri(); ?>/assets/icons/touch-icon-ipad-retina.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="<?php echo get_template_directory_uri(); ?>/assets/icons/touch-icon-iphone-retina.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
          href="<?php echo get_template_directory_uri(); ?>/assets/icons/touch-icon-ipad.png">
    <link rel="apple-touch-icon-precomposed"
          href="<?php echo get_template_directory_uri(); ?>/assets/icons/touch-icon-iphone.png">
  ...
  <body <?php body_class(); ?>>
    ...
    <main class="block-main" role="main">
      ...
      <div class="row">
        ...
        <div class="columns <?= is_page_template( 'page-fullwidth.php') || is_404() ? FULLWIDTH_SIZE : MAIN_SIZE; ?>" role="main">
